...
import { DebuggerApp } from '../../debug/page/debug.tsx';
import { ControlNav } from './control-nav.tsx';
import { OptionsApp } from './settings.tsx';
import './settings.css';
import './landing.css';
...
if (!appRoot) throw new Error('Settings app root is missing');
render(<App />, appRoot);
