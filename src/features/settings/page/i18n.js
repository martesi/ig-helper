...
const english = {
    ...
    FORCE_FETCH_ALL_RESOURCES_INTRO: 'Fetch all resources in a post through the Instagram API.',
    DIRECT_DOWNLOAD_VISIBLE_RESOURCE_INTRO: 'Directly download the currently visible resources in the post.',
    DIRECT_DOWNLOAD_ALL_INTRO: 'Fetch and download all resources when the download button is used.',
    DIRECT_DOWNLOAD_STORY_INTRO: 'Download all story or highlight resources without the selection dialog.',
    ...
    SCROLL_BUTTON_INTRO: 'Show scroll buttons in the lower-right corner of the Reels page.',
